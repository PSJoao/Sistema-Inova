    ...
    try {
        ...
        const mainQuery = `
            SELECT 
                ...
                a.data_solicitacao, a.periodo_solicitacao, a.marcar_como_alerta, a.observacoes, 
...
exports.createAssistencia = async (req, res) => {
    ...
    try {
        await client.query('BEGIN');
        const {
            descricao, solicitante_id, fabrica_id, data_solicitacao, periodo_solicitacao, nf_origem, nome_pedido, documento_cliente,
...
exports.updateAssistencia = async (req, res) => {
    ...
    try {
        ...
        const {
            descricao, solicitante_id, data_solicitacao, periodo_solicitacao, nf_origem, nome_pedido, documento_cliente,
            numero_pedido_venda, coluna_estoque, linha_estoque, observacoes, marcar_como_alerta,
...
exports.updateSingleStatusAPI = async (req, res) => {
    ...
    if (!status || !['Pendente', 'Pronta para Embalar', 'Descarte', 'Resolvida', 'Para Vistoriar', 'Não Encontrado', 'Mapeado'].includes(status)) {
...
exports.updateVolumeStatusAPI = async (req, res) => {
    ...
    const validStatuses = ['Pendente', 'Pronta para Embalar', 'Descarte', 'Resolvida', 'Não Encontrado', 'Para Vistoriar', 'Volume Bom', 'Volume Ruim', 'Mapeado'];
...
exports.findNfInBlingAPI = async (req, res) => {
    ...
    try {
        ...
        await findAndCacheNfeByNumber(numero, targetAccount, false);
...
exports.exportAssistenciasExcel = async (req, res) => {
    try {
        ...
        const mainQuery = `
            SELECT 
                ...
                CASE 
                    ...
                    ELSE a.situacao
                END as situacao,
                to_char(a.data_solicitacao, 'DD/MM/YYYY') as data_solicitacao, a.periodo_solicitacao,
        ...
        const dataForExcel = rows.map(a => ({
            ...
            'Período Solic.': a.periodo_solicitacao,
